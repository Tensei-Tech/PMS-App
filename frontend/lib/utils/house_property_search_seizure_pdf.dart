...
Future<Uint8List> generateHousePropertySearchSeizurePdf(
  ...
  pw.Widget underlineField(String valKey, String fallback,
      {bool expanded = false, double? width}) {
  ...
  pw.Widget witnessBlock(
      String num, String l1Key, String l2Key, String l3Key, String sigKey) {
    return pw.Row(
      crossAxisAlignment: pw.CrossAxisAlignment.start,
      children: [
        pw.Expanded(
            ...
            children: [
              pw.Row(
                ...
                children: [
                  ...
                  underlineField(l1Key, doc[l1Key]?.toString() ?? '',
                      expanded: true),
                ],
              ),
              pw.Padding(
                padding: const pw.EdgeInsets.only(left: 16),
                child: underlineField(l2Key, doc[l2Key]?.toString() ?? '',
                    expanded: true),
              ),
              pw.Padding(
                padding: const pw.EdgeInsets.only(left: 16),
                child: underlineField(l3Key, doc[l3Key]?.toString() ?? '',
                    expanded: true),
              ),
            ],
          ),
        ...
        pw.Expanded(
          child: pw.Row(
            ...
            children: [
              pw.Text('$num) ', style: englishBold),
              underlineField(sigKey, doc[sigKey]?.toString() ?? '',
                  expanded: true),
            ],
          ),
        ),
        ...
        build: (_) => pw.Column(
          ...
          children: [
            ...
            pw.Wrap(
              ...
              children: [
                inlineField('1.Dist : ', 'lbl_dist', 'val_dist',
                    doc['dist']?.toString() ?? '',
                    width: 55),
                inlineField(
                    'P.S: ', 'lbl_ps', 'val_ps', doc['ps']?.toString() ?? '',
                    width: 55),
            ...
            pw.Row(
              children: [
                inlineField('Name : - ', 'lbl_person_name', 'val_personName',
                    ...
                    width: 70),
                pw.SizedBox(width: 6),
                inlineField('Father\'s/Husband\'s Name : ', 'lbl_person_father',
                    'val_personFather', doc['personFather']?.toString() ?? '',
                    width: 70),
                inlineField('Sex- ', 'lbl_person_sex', 'val_personSex',
            ...
            pw.Row(
              children: [
                inlineField('Age : ', 'lbl_person_age', 'val_personAge',
                ...
                inlineField(
                    ...
                    width: 60),
                inlineField('Address : ', 'lbl_person_addr',
                    'val_personAddress', doc['personAddress']?.toString() ?? '',
                    width: 80),
              ],
            ),
            pw.Padding(
              padding: const pw.EdgeInsets.only(left: 8),
              child: underlineField('val_personAddressLine2',
      ...
      pw.Page(
        ...
        build: (_) => pw.Column(
          ...
          children: [
            ...
            pw.Row(
              children: [
                inlineField(
                    ...
                    width: 55),
                pw.SizedBox(width: 6),
                inlineField('(b) Time : ', 'lbl_seize_time_from',
                    'val_seizeTimeFrom', doc['seizeTimeFrom']?.toString() ?? '',
                    width: 40),
            ...
            pw.SizedBox(height: 4),
            witnessBlock('1', 'witness1Line1', 'witness1Line2', 'witness1Line3',
                'witness1Sig'),
            pw.SizedBox(height: 4),
            witnessBlock('2', 'witness2Line1', 'witness2Line2', 'witness2Line3',
                'witness2Sig'),
            pw.SizedBox(height: 8),
            pw.Row(
              crossAxisAlignment: pw.CrossAxisAlignment.start,
...
Future<MarathiImageCache> _preRenderAllMarathi(Map<String, dynamic> doc) async {
  ...
  await addLbl(
      'lbl_place_desc', 'जप्तीच्या परत मिळवल्याच्या जागेचे वर्णन /चतु सिमा');
  ...
  await addLbl(
      'lbl_property_details', 'जप्त केलेल्या / परत मिळालेल्या मालाचे वर्णन');
