      ...
      children: [
        ...
        pw.Padding(
          ...
          child: pw.Column(
            ...
            children: [
              pw.Text(enLabel, style: headerEnglishStyle.copyWith(fontSize: 10)),
              pw.SizedBox(height: 2),
              if (cache.has(labelKey)) cache.img(labelKey) else pw.SizedBox(),
            ],
          ),
        ),
        pw.Padding(
      ...
      build: (pw.Context context) {
        return [
          ...
          pw.Table(
            ...
            children: [
              buildPdfRow('1.', 'Police Station:', 'lbl_1', 'val_1', doc['field1']),
              buildPdfRow('2.', 'Name and Address of Complainant:', 'lbl_2', 'val_2', doc['field2']),
              buildPdfRow('3.', 'City or Village of Crime:', 'lbl_3', 'val_3', doc['field3']),
              buildPdfRow('4.', 'Date of Crime:', 'lbl_4', 'val_4', doc['field4']),
              buildPdfRow('5.', 'Crime No. & Section:', 'lbl_5', 'val_5', doc['field5']),
              buildPdfRow('6.', 'Value of Stolen Property:', 'lbl_6', 'val_6', doc['field6']),
              buildPdfRow('7.', 'Value of Recovered Property:', 'lbl_7', 'val_7', doc['field7']),
              buildPdfRow('8.', 'Class of Person/Property Attacked:', 'lbl_8', 'val_8', doc['field8']),
              buildPdfRow('9.', 'Means used to reach Crime Scene:', 'lbl_9', 'val_9', doc['field9']),
              buildPdfRow('10.', 'Method used to commit crime:', 'lbl_10', 'val_10', doc['field10']),
              buildPdfRow('11.', 'Instrument Used:', 'lbl_11', 'val_11', doc['field11']),
              buildPdfRow('12.', 'Time of Day:', 'lbl_12', 'val_12', doc['field12']),
              buildPdfRow('13.', 'Accomplices:', 'lbl_13', 'val_13', doc['field13']),
              buildPdfRow('14.', 'Vehicle:', 'lbl_14', 'val_14', doc['field14']),
              buildPdfRow('15.', 'Specific Identification Mark:', 'lbl_15', 'val_15', doc['field15']),
              buildPdfRow('16.', 'Style/Modus Operandi:', 'lbl_16', 'val_16', doc['field16']),
              buildPdfRow('17.', 'Fabricated Story / Motive:', 'lbl_17', 'val_17', doc['field17']),
              buildPdfRow('18.', 'Brief Facts of the Case:', 'lbl_18', 'val_18', doc['field18']),
            ],
          ),
        ];
      },
