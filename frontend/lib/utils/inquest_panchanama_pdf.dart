        ...
        child: Text.rich(
          TextSpan(
            ...
            children: [
              ...
              FormImagePdfHelper.inlineFieldSpan(v('reqMargDate'), emptyWidth: 75),
              const TextSpan(text: ' रोजी '),
              FormImagePdfHelper.inlineFieldSpan(v('reqMargTime'), emptyWidth: 50),
              const TextSpan(text: ' वाजता पोलीस स्टेशन '),
              FormImagePdfHelper.inlineFieldSpan(v('reqMargPs'), emptyWidth: 100),
              const TextSpan(text: ' मर्ग/ स्टेशन डायरी क्र. '),
              FormImagePdfHelper.inlineFieldSpan(v('reqMargDiaryNo'), emptyWidth: 60),
              const TextSpan(text: '/२०'),
              FormImagePdfHelper.inlineFieldSpan(v('reqMargYear'), emptyWidth: 40),
              const TextSpan(
                  text:
                      ' कलम १९४ बी.एन.एस.एस २०२३ चा मर्ग दाखल झाला असुन यातील मृतक नामे '),
              FormImagePdfHelper.inlineFieldSpan(v('reqMargName'), emptyWidth: 200),
              const TextSpan(text: ' पो.स्टे. '),
              FormImagePdfHelper.inlineFieldSpan(v('reqSubjectPs'), emptyWidth: 95),
              const TextSpan(text: ' ता- '),
              FormImagePdfHelper.inlineFieldSpan(v('reqMargTa'), emptyWidth: 75),
              const TextSpan(text: ' जिल्हा ......... ही/ह्या '),
              FormImagePdfHelper.inlineFieldSpan(v('reqHospitalName'), emptyWidth: 150),
              const TextSpan(text: ' येथे दिनांक '),
              FormImagePdfHelper.inlineFieldSpan(v('reqAdmitDate'), emptyWidth: 75),
              const TextSpan(text: ' रोजी '),
              FormImagePdfHelper.inlineFieldSpan(v('reqAdmitTime'), emptyWidth: 50),
              const TextSpan(
                  text:
                      ' वाजता भरती झाला असुन औषधोपचारा दरम्यान/ गळफास लावुन/ विष प्राशन करून/अपघात/ '),
              FormImagePdfHelper.inlineFieldSpan(v('reqReasonDetails'), emptyWidth: 170),
              const TextSpan(text: ' दिनांक '),
              FormImagePdfHelper.inlineFieldSpan(v('reqDeathDate'), emptyWidth: 75),
              const TextSpan(text: ' रोजी '),
              FormImagePdfHelper.inlineFieldSpan(v('reqDeathTime'), emptyWidth: 50),
      ...
      Padding(
        ...
        child: Text.rich(
          TextSpan(
            style: mrR.copyWith(height: 1.8),
            children: [
              const TextSpan(text: 'आपणास या समन्सव्दारे कळविण्यात येते की, आम्ही '),
              FormImagePdfHelper.inlineFieldSpan(v('relWeName'), emptyWidth: 160),
              const TextSpan(text: ' पोलीस स्टेशन '),
              FormImagePdfHelper.inlineFieldSpan(v('relPsName'), emptyWidth: 110),
              const TextSpan(text: ' येथील अप/ मर्ग/ ठाणे दैनंदिनी क्रमांक '),
              FormImagePdfHelper.inlineFieldSpan(v('relCrDiaryNo'), emptyWidth: 60),
              const TextSpan(text: '/२०'),
              FormImagePdfHelper.inlineFieldSpan(v('relCrYear'), emptyWidth: 40),
              const TextSpan(text: ' कलम '),
              FormImagePdfHelper.inlineFieldSpan(v('relActSec'), emptyWidth: 130),
              const TextSpan(text: ' मधील मृतक नामे '),
              FormImagePdfHelper.inlineFieldSpan(v('relDeceasedName'), emptyWidth: 190),
              const TextSpan(text: ' ता-'),
      ...
      Padding(
        ...
        child: Text.rich(
          TextSpan(
            ...
            children: [
              const TextSpan(text: 'आपणास या समन्सव्दारे कळविण्यात येते की, आम्ही '),
              FormImagePdfHelper.inlineFieldSpan(v('panWeName'), emptyWidth: 160),
              const TextSpan(text: ' पोलीस स्टेशन '),
              FormImagePdfHelper.inlineFieldSpan(v('panPsName'), emptyWidth: 110),
              const TextSpan(text: ' येथील अप/ मर्ग/ ठाणे दैनंदिनी क्रमांक '),
              FormImagePdfHelper.inlineFieldSpan(v('panCrDiaryNo'), emptyWidth: 60),
              const TextSpan(text: '/२०'),
              FormImagePdfHelper.inlineFieldSpan(v('panCrYear'), emptyWidth: 40),
              const TextSpan(text: ' कलम '),
              FormImagePdfHelper.inlineFieldSpan(v('panActSec'), emptyWidth: 130),
              const TextSpan(text: ' मधील मृतक नामे '),
              FormImagePdfHelper.inlineFieldSpan(v('panDeceasedName'), emptyWidth: 190),
              const TextSpan(text: ' ता-'),
      ...
      Text.rich(
        TextSpan(
          ...
          children: [
            ...
            FormImagePdfHelper.inlineFieldSpan(v('ptpReceiverName'), emptyWidth: 180),
            const TextSpan(text: ' रा. '),
            FormImagePdfHelper.inlineFieldSpan(v('ptpReceiverRa'), emptyWidth: 140),
            const TextSpan(text: ' ता '),
            FormImagePdfHelper.inlineFieldSpan(v('ptpReceiverTa'), emptyWidth: 80),
            const TextSpan(text: ' जिल्हा '),
            FormImagePdfHelper.inlineFieldSpan(v('ptpReceiverDist'), emptyWidth: 100),
            ...
            FormImagePdfHelper.inlineFieldSpan(v('ptpReceiptDate'), emptyWidth: 110),
            const TextSpan(text: ' रोजी मृतक नामे '),
            FormImagePdfHelper.inlineFieldSpan(v('ptpDeceasedName'), emptyWidth: 180),
            const TextSpan(text: ' रा. '),
            FormImagePdfHelper.inlineFieldSpan(v('ptpDeceasedRa'), emptyWidth: 120),
            const TextSpan(text: ' ता आणि जिल्हा '),
            FormImagePdfHelper.inlineFieldSpan(v('ptpDeceasedDist'), emptyWidth: 100),
            const TextSpan(
              text:
                  ' हयाचे / हिचे प्रेत पोस्टमार्टम होवुन अंतिम संस्काराकरीता माझे ताब्यात मिळाले आहे. सदर प्रेत हे नमुद मृतकाचेच आहे. मी मृतकाचा वारसा या नात्याने ताब्यात घेतले आहे. माझी कोणत्याच प्रकारची तक्रार नाही.',
            ),
      ...
      Text.rich(
        TextSpan(
          ...
          children: [
            ...
            const TextSpan(text: ' मधील मृतक नामे '),
            FormImagePdfHelper.inlineFieldSpan(v('dpDeceasedName'), emptyWidth: 180),
            const TextSpan(text: ' रा. '),
            FormImagePdfHelper.inlineFieldSpan(v('dpDeceasedRa'), emptyWidth: 120),
            const TextSpan(text: ' ता आणि जिल्हा '),
            ...
            FormImagePdfHelper.inlineFieldSpan(v('dpMedOfficerName'), emptyWidth: 160),
            const TextSpan(
              text:
                  ' यांचेकडे शवविच्छेदनाकरीता दाखल करावे. व शवविच्छेदनानंतर प्रेत मृतकाचे वारसदारास ताब्यात देउन मा. वैद्यकीय अधिकारी यांनी पि. एम दरम्यान व्हिसेरा कपडा बंडल दिल्यास ताब्यात घेउन तपासी अंमलदार यांचेकडे दाखल करावे.',
            ),
        ...
        children: [
          Row(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.only(top: 1.0),
                child: SizedBox(width: 90, child: Text(labelEn, style: engBold)),
              ),
    ...
    children: [
      ...
      Row(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.only(top: 1.0),
            child: Text('9) Description Of injuries Found on Dead Body if any :',
                style: engBold),
          ),
    ...
    children: [
      ...
      Row(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.only(top: 1.0),
            child: Text('३) अकस्मात मृत्यु/गुन्हा/ठाणे दैनंदिनी क्र:-', style: mrB),
          ),
