...
class CaseFormScreen extends StatefulWidget {
  ...
  const CaseFormScreen(
      {super.key, required this.categoryName, this.existingCase});
      ...
      body: Center(
        child: ConstrainedBox(
          constraints: BoxConstraints(
            maxWidth:
                MediaQuery.of(context).size.width > 900 ? 800 : double.infinity,
          ),
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildCard([
                    _buildTextField(
                        'Case / FIR Number', _caseNoCtrl, Icons.numbers_rounded,
                        hint: 'e.g. FIR/2024/102'),
                    const SizedBox(height: AppSpacing.md),
                    _buildTextField(
                        'Subject / Case Title', _titleCtrl, Icons.title_rounded,
                  ...
                  _buildSectionTitle(
                      'Incident Details', Icons.location_on_outlined),
                  _buildCard([
                    _buildTextField(
                        'Location', _locationCtrl, Icons.map_rounded,
                        hint: 'Place of occurrence'),
                    const SizedBox(height: AppSpacing.md),
                    _buildTextField(
                        'Description', _descCtrl, Icons.description_outlined,
                        hint: 'Detailed explanation...', maxLines: 4),
                  ]),
                  const SizedBox(height: AppSpacing.lg),
                  _buildSectionTitle(
                      'Parties Involved', Icons.people_outline_rounded),
                  _buildCard([
                    _buildTextField('Complainant Name', _complainantCtrl,
                        Icons.person_add_alt_rounded),
                    const SizedBox(height: AppSpacing.md),
                    _buildTextField('Accused Name / Description', _accusedCtrl,
                        Icons.person_off_rounded,
                        hint: 'Leave empty if unknown'),
                  ]),
                  const SizedBox(height: AppSpacing.lg),
                  _buildSectionTitle(
                      'Priority & Status', Icons.priority_high_rounded),
                  _buildCard([
      ...
      child: ElevatedButton(
          ...
          if (_formKey.currentState!.validate()) {
            ...
            final record = ModuleRecord(
              ...
              assignedOfficer: isEdit
                  ...
                  : auth.displayName,
              createdAt:
                  isEdit ? widget.existingCase!.createdAt : DateTime.now(),
        ...
        child: Text(
          TranslationHelper.translate(
              context, isEdit ? 'Update Details' : 'Submit Application'),
          style: GoogleFonts.poppins(
            fontSize: 16,
            fontWeight: FontWeight.w700,
            color: Colors.white,
