...
class CommonFormDocumentView extends StatelessWidget {
  ...
  Widget _personCard(
      BuildContext context, String heading, Map<String, dynamic> p) {
    return Container(
      width: double.infinity,
        ...
        [
          if (charges.isEmpty)
            Text('No charges added.',
                style: GoogleFonts.poppins(
                    fontStyle: FontStyle.italic, color: AppColors.lightSubText))
          else
            ...
            ..._pairedSimpleFields(context, [
              (
                ...
                value: (commonMap['isSexualOffence'] == true ||
                        (comp['name']?.toString().contains('Protected') ??
                            false))
                ...
                child: Row(
                  children: [
                    Icon(
                      ...
                      size: 20,
                      color:
                          ok ? AppColors.successGreen : AppColors.lightSubText,
                    ),
                    const SizedBox(width: 8),
                    Expanded(
                      child: Text(
                        ...
                        style: GoogleFonts.poppins(
                          fontSize: 13,
                          color:
                              ok ? AppColors.navyDark : AppColors.lightSubText,
                          fontWeight: FontWeight.w600,
                        ),
                      ),
                    ),
