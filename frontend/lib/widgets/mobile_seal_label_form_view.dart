        ...
        FormPaperPage(
          ...
          children: [
            Center(
              child: Column(
                children: [
                  Text('MOBILE SEAL LABEL',
                      style: serif.copyWith(
                          fontSize: 16, fontWeight: FontWeight.bold)),
                  Text('मोबाईल शिक्का लेबल',
            ...
            BilingualFieldRow(
              fields: [
                BilingualField(
                    label: 'Label No.',
                    marathiLabel: 'लेबल क्र.',
                    controller: _fields['labelNo']!,
                    serifStyle: serif,
            ...
            BilingualFieldRow(
              fields: [
                BilingualField(
                    label: 'Make',
                    marathiLabel: 'कंपनी',
                    controller: _fields['mobileMake']!,
                    serifStyle: serif,
                    marathiLabelStyle: marathi),
                BilingualField(
                    label: 'Model',
                    marathiLabel: 'मॉडेल',
                    controller: _fields['mobileModel']!,
                    serifStyle: serif,
                    marathiLabelStyle: marathi),
              ],
            ),
            BilingualFieldRow(
              fields: [
                BilingualField(
                    label: 'IMEI 1',
                    marathiLabel: 'IMEI १',
                    controller: _fields['imei1']!,
                    serifStyle: serif,
                    marathiLabelStyle: marathi),
                BilingualField(
                    label: 'IMEI 2',
                    marathiLabel: 'IMEI २',
                    controller: _fields['imei2']!,
                    serifStyle: serif,
                    marathiLabelStyle: marathi),
              ],
            ),
            BilingualField(
                label: 'SIM No.',
                marathiLabel: 'SIM क्र.',
                controller: _fields['simNo']!,
                serifStyle: serif,
                marathiLabelStyle: marathi),
            BilingualFieldRow(
              fields: [
