...
Future<Uint8List> generateArrestSurrenderPdf(Map<String, dynamic> doc) async {
  ...
  pw.Widget field(String labelText, String valKey, String fallback,
      {double? width}) {
    return pw.Row(
  ...
  pw.Widget buildInlineFieldWithMLbl(
      String enLabel, String mKey, String valKey, String fallback,
      {double? width}) {
    return pw.Row(
        mainAxisSize: pw.MainAxisSize.min,
        crossAxisAlignment: pw.CrossAxisAlignment.end,
  ...
  pw.Widget check(String text, bool value,
      {bool isMarathi = false, String? mKey}) {
    return pw.Row(
        mainAxisSize: pw.MainAxisSize.min,
          ...
          return pw.Column(
              ...
              children: [
                ...
                pw.Center(
                  ...
                  pw.Text('ARREST/COURT SURRENDER FORM',
                      style: headerEnglishStyle),
                  pw.SizedBox(height: 4),
                  mLbl('title_m1'),
                  mLbl('title_m2'),
                  pw.SizedBox(height: 8),
                  pw.Text('(Separate Memo for each accused)',
                      style: englishBold),
                  mLbl('title_m3'),
                ])),
                ...
                pw.Wrap(spacing: 8, runSpacing: 4, children: [
                  buildInlineFieldWithMLbl(
                      '1.Dist.', 'lbl_dist', 'val_dist', doc['dist'],
                      width: 60),
                  buildInlineFieldWithMLbl(
                      'P.S.:', 'lbl_ps', 'val_ps', doc['ps'],
                      width: 60),
                  buildInlineFieldWithMLbl('FIR/Proceeding/G.D.No:', 'lbl_fir',
                      'val_fir', doc['firNo'],
                      width: 60),
                  buildInlineFieldWithMLbl(
                      'Year:-20', 'lbl_year', 'val_year', doc['year'],
                      width: 30),
                  buildInlineFieldWithMLbl(
                      'Date', 'lbl_date', 'val_date', doc['date'],
                      width: 60),
                ]),
                pw.SizedBox(height: 4),
                pw.Row(children: [
                  ...
                  pw.Expanded(
                    child: pw.Container(
                      decoration: const pw.BoxDecoration(
                          border: pw.Border(bottom: pw.BorderSide(width: 0.5))),
                      child: renderText(
                          'val_code', doc['accusedCode'], englishStyle),
                    ),
                  ),
                ]),
                ...
                pw.Wrap(spacing: 8, runSpacing: 4, children: [
                  buildInlineFieldWithMLbl(
                      ...
                      width: 60),
                  buildInlineFieldWithMLbl(
                      'Time', 'lbl_arr_time', 'val_arrTime', doc['arrestTime'],
                      width: 60),
                  buildInlineFieldWithMLbl(
                      'G.D.No.', 'lbl_arr_gd', 'val_arrGd', doc['arrestGdNo'],
                      width: 60),
                ]),
                pw.SizedBox(height: 4),
                pw.Wrap(spacing: 8, runSpacing: 4, children: [
                  buildInlineFieldWithMLbl('Place of Arrest: - P.S.',
                      'lbl_arr_ps', 'val_arrPlace', doc['arrestPlace'],
                      width: 100),
                  buildInlineFieldWithMLbl(
                      'Dist.', 'lbl_arr_dist', 'val_arrDist', doc['arrestDist'],
                      width: 80),
                  buildInlineFieldWithMLbl('State.', 'lbl_arr_state',
                      'val_arrState', doc['arrestState'],
                      width: 80),
                ]),
                pw.SizedBox(height: 12),
                ...
                pw.Row(
                    ...
                    children: [
                      pw.Column(
                          crossAxisAlignment: pw.CrossAxisAlignment.start,
                          children: [
                            pw.Text('3. Name of the Court ( if surrendered) :-',
                                style: englishBold),
                            mLbl('lbl_court'),
                          ]),
                      pw.SizedBox(width: 4),
                      pw.Expanded(
                        child: pw.Container(
                          ...
                          child: renderText(
                              'val_court', doc['courtName'], englishStyle),
                        ),
                      ),
                    ]),
                pw.SizedBox(height: 12),
                        ...
                        child: pw.Container(
                          decoration: const pw.BoxDecoration(
                              border:
                                  pw.Border(bottom: pw.BorderSide(width: 0.5))),
                          child: renderText(
                              'val_acts', doc['actsSections'], englishStyle),
                        ),
                      ),
                    ]),
                pw.SizedBox(height: 12),
                ...
                pw.SizedBox(height: 4),
                pw.Wrap(spacing: 8, runSpacing: 4, children: [
                  check('Arrested and forward',
                      doc['arrestedAndForwarded'] == true),
                  check('Arrested and released on bail',
                      doc['arrestedAndBailed'] == true),
                  check('Arrested but released on anticipatory bail',
                      doc['arrestedButAnticipatory'] == true),
                  check('Arrested and remanded to police Custody',
                      doc['arrestedAndRemandedPolice'] == true),
                  check('Surrender in court and bailed out',
                      doc['surrenderBailed'] == true),
                  check('Surrender in court and sent to judicial Custody',
                      doc['surrenderJudicial'] == true),
                  check('Surrender in court and remanded to police custody',
                      doc['surrenderPolice'] == true),
                ]),
                pw.SizedBox(height: 12),

                // 6
                pw.Text('6. Particulars of the Accused ( आरोपीचा तपशील ) :-',
                    style: englishBold),
                pw.Padding(
                    ...
                    child: pw.Column(
                        ...
                        children: [
                          ...
                          field(
                              ...
                              width: 200),
                          pw.SizedBox(height: 4),
                          field('(iii)Fist Alias (पहिले टोपण नांव ):-',
                              'val_accAlias1', doc['accusedAlias1'],
                              width: 250),
                          pw.SizedBox(height: 4),
                          field('(iv)Second Alias (दुसरे टोपण नांव ):-',
                              'val_accAlias2', doc['accusedAlias2'],
                              width: 250),
                          pw.SizedBox(height: 4),
                          field('(v) Nationality (राष्ट्रीयत्व) :-',
                              'val_accNat', doc['accusedNationality'],
                              width: 200),
                          pw.SizedBox(height: 4),
                          pw.Wrap(spacing: 16, runSpacing: 4, children: [
                            field('(vi) (a) Voter ID. Card No: -',
                                'val_accVoter', doc['accusedVoter'],
                                width: 100),
                            field('(b) *Passport No: -', 'val_accPass',
                                doc['accusedPassport'],
                                width: 100),
                          ]),
                          pw.Wrap(spacing: 16, runSpacing: 4, children: [
                          ...
                          pw.Wrap(spacing: 16, runSpacing: 4, children: [
                            field('(c) Date of iisue :-', 'val_accDateIss',
                                doc['accusedDateIssue'],
                                width: 100),
                            field('(d) *Place or Issue :-', 'val_accPlaceIss',
                          ...
                          pw.Wrap(spacing: 16, runSpacing: 4, children: [
                            buildInlineFieldWithMLbl('(ix) SC/ST/OBC :-',
                                'lbl_6ix_m1', 'val_accScSt', doc['accusedScSt'],
                                width: 100),
                            buildInlineFieldWithMLbl(
                                '(x)*Occupation :-',
                                'lbl_6x_m1',
                              ...
                              children: [
                                ...
                                pw.Expanded(
                                  child: pw.Container(
                                    ...
                                    child: renderText('val_permAddr',
                                        doc['permAddress'], englishStyle),
                                  ),
                                ),
                              ]),
                          pw.Wrap(spacing: 8, runSpacing: 4, children: [
                            buildInlineFieldWithMLbl('State :-', 'lbl_state',
                                'val_permState', doc['permState'],
                                width: 80),
                            buildInlineFieldWithMLbl('Dist.:-', 'lbl_dist2',
                                'val_permDist', doc['permDist'],
                                width: 80),
                            buildInlineFieldWithMLbl('P.S. :-', 'lbl_ps2',
                                'val_permPs', doc['permPs'],
                                width: 80),
                          ]),
                          pw.SizedBox(height: 4),
                          pw.Row(
                                ...
                                pw.Expanded(
                                  child: pw.Container(
                                    decoration: const pw.BoxDecoration(
                                        border: pw.Border(
                                            bottom: pw.BorderSide(width: 0.5))),
                                    child: renderText('val_presAddr',
                                        doc['presAddress'], englishStyle),
                                  ),
                                ),
                              ]),
                          pw.Wrap(spacing: 8, runSpacing: 4, children: [
                            buildInlineFieldWithMLbl('State: -', 'lbl_state',
                                'val_presState', doc['presState'],
                                width: 80),
                            buildInlineFieldWithMLbl('Dist.:-', 'lbl_dist2',
                                'val_presDist', doc['presDist'],
                                width: 80),
                            buildInlineFieldWithMLbl('P.S. :-', 'lbl_ps2',
                                'val_presPs', doc['presPs'],
                                width: 80),
                          ]),
                        ])),
                pw.SizedBox(height: 12),
                ...
                pw.Container(
                  ...
                  decoration: const pw.BoxDecoration(
                      border: pw.Border(bottom: pw.BorderSide(width: 0.5))),
                  child:
                      renderText('val_injuries', doc['injuries'], englishStyle),
                ),
              ]);
        }));
  }
          ...
          return pw.Column(
              ...
              children: [
                      ...
                      pw.Container(
                        ...
                        decoration: const pw.BoxDecoration(
                            border:
                                pw.Border(bottom: pw.BorderSide(width: 0.5))),
                        child: renderText(
                            'val_cusDate', doc['custodyDate'], englishStyle),
                      ),
                      ...
                      pw.Container(
                        ...
                        decoration: const pw.BoxDecoration(
                            border:
                                pw.Border(bottom: pw.BorderSide(width: 0.5))),
                        child: renderText(
                            'val_cusHours', doc['custodyHours'], englishStyle),
                      ),
                      ...
                      pw.Container(
                        ...
                        decoration: const pw.BoxDecoration(
                            border:
                                pw.Border(bottom: pw.BorderSide(width: 0.5))),
                        child: renderText(
                            'val_cusPlace', doc['custodyPlace'], englishStyle),
                      ),
                ...
                pw.Row(children: [
                  pw.Expanded(
                      child:
                          field('1 ', 'val_art1', doc['article1'], width: 150)),
                  pw.Expanded(
                      child:
                          field('2 ', 'val_art2', doc['article2'], width: 150)),
                ]),
                pw.SizedBox(height: 4),
                pw.Row(children: [
                  pw.Expanded(
                      child:
                          field('3 ', 'val_art3', doc['article3'], width: 150)),
                  pw.Expanded(
                      child:
                          field('4 ', 'val_art4', doc['article4'], width: 150)),
                ]),
                pw.SizedBox(height: 4),
                pw.Row(children: [
                  pw.Expanded(
                      child:
                          field('5 ', 'val_art5', doc['article5'], width: 150)),
                  pw.Expanded(
                      child:
                          field('6 ', 'val_art6', doc['article6'], width: 150)),
                ]),
                pw.SizedBox(height: 12),
                ...
                pw.Row(children: [
                  field('Intimation given to Name: ', 'val_intName',
                      doc['intimationName'],
                      width: 150),
                  pw.SizedBox(width: 16),
                  field('(Relationship):', 'val_intRel', doc['intimationRel'],
                      width: 100),
                ]),
                pw.Row(children: [
                  mLbl('lbl_8_m6'),
                ...
                children: [
                  ...
                  pw.Expanded(
                    child: pw.Container(
                      ...
                      child: renderText('val_otherFeatures',
                          doc['otherFeatures']?.toString(), englishStyle),
                    ),
                  ),
                ],
              ),
        ...
        build: (pw.Context context) {
          return pw.Column(
              ...
              children: [
                ...
                pw.Row(
                    ...
                    children: [
                      pw.Column(
                          crossAxisAlignment: pw.CrossAxisAlignment.start,
                          children: [
                            pw.Text('10. Whether finger print taken or not? :',
                                style: englishBold),
                            mLbl('lbl_10_m1'),
                          ]),
                      pw.SizedBox(width: 8),
                ...
                // 11
                pw.Text('11. Socio-economic profile of the accused showing.',
                    style: englishBold),
                pw.Padding(
                    padding: const pw.EdgeInsets.only(left: 16),
                    child: pw.Column(
                        ...
                        children: [
                          ...
                          pw.Wrap(spacing: 8, runSpacing: 4, children: [
                            ...
                            check(
                                'Kacheha House', doc['livingKachcha'] == true),
                            check('Thatehed House',
                                doc['livingThatched'] == true),
                          ...
                          pw.Row(children: [
                            buildInlineFieldWithMLbl(
                                ...
                                width: 120),
                            pw.SizedBox(width: 16),
                            buildInlineFieldWithMLbl('(c) occupation',
                                'lbl_11c_m1', 'val_occ2', doc['occupation2'],
                                width: 120),
                          ]),
                          pw.SizedBox(height: 12),
                          pw.Text('(d) Income Group ( उत्पन्न गट ) :-',
                              style: englishBold),
                          mLbl('lbl_11d_m1'),
                          pw.SizedBox(height: 4),
                          check(
                            ...
                            pw.Expanded(
                              child: pw.Container(
                                decoration: const pw.BoxDecoration(
                                    border: pw.Border(
                                        bottom: pw.BorderSide(width: 0.5))),
                                child: renderText('val_caseRef',
                                    doc['caseRefSec'], englishStyle),
                              ),
                            ),
                          ]),
                        ])),
                ...
                pw.Row(children: [
                  pw.Expanded(
                      child: buildInlineFieldWithMLbl('13. पंचाची नांवे (1) :',
                          'lbl_13_m1', 'val_p1Name', doc['panch1Name'])),
                  pw.Expanded(
                      child: buildInlineFieldWithMLbl('पंचाच्या सहया (1) :',
                          'lbl_13_m2', 'val_p1Sig', doc['panch1Sig'])),
                ]),
                pw.SizedBox(height: 4),
                pw.Row(
                ...
                pw.Row(children: [
                  ...
                  pw.Expanded(
                      child: buildInlineFieldWithMLbl('पंचाच्या सहया (2) :',
                          'lbl_13_m3', 'val_p2Sig', doc['panch2Sig'])),
                ]),
                pw.SizedBox(height: 4),
                    ...
                    children: [
                      pw.Expanded(
                          child: pw.Column(
                            ...
                            mLbl('lbl_14_m1'),
                            pw.SizedBox(height: 16),
                            field(':', 'val_arrSig', doc['arrestedPersonSig'],
                                width: 150),
                            pw.SizedBox(height: 16),
                            pw.Text('15.', style: englishBold),
                            buildInlineFieldWithMLbl('Place: ', 'lbl_15_m1',
                                'val_fPlace', doc['finalPlace'],
                                width: 100),
                            pw.SizedBox(height: 8),
                            buildInlineFieldWithMLbl('Date: ', 'lbl_15_m2',
                                'val_fDate', doc['finalDate'],
                                width: 100),
                          ])),
                      pw.Expanded(
                          child: pw.Column(
                            ...
                            pw.SizedBox(height: 8),
                            field(
                                'Signature / सही :-', 'val_ioSig', doc['ioSig'],
                                width: 150),
                            pw.SizedBox(height: 16),
                            buildInlineFieldWithMLbl('Name: ', 'lbl_15_m3',
                                'val_fName', doc['finalName'],
                                width: 150),
                            pw.SizedBox(height: 8),
                            pw.Row(children: [
                              buildInlineFieldWithMLbl('Rank: ', 'lbl_15_m4',
                                  'val_fRank', doc['finalRank'],
                                  width: 80),
                              pw.SizedBox(width: 8),
                              buildInlineFieldWithMLbl('No: ', 'lbl_15_m5',
                                  'val_fNo', doc['finalNo'],
                                  width: 60),
                            ])
                          ])),
...
pw.Widget _yesNoRow(
    String label, bool value, pw.TextStyle style, pw.TextStyle boldStyle) {
  return pw.Padding(
...
pw.Widget _buildPdfTable({
  ...
  return pw.Table(border: pw.TableBorder.all(width: 1), columnWidths: {
...
Future<MarathiImageCache> _preRenderAllMarathi(Map<String, dynamic> doc) async {
  ...
  await addLbl('title_m3', '(प्रत्येक आरोपीसाठी स्वतंत्र नमुना वापरावा)',
      marathiLabelStyle);
  ...
  await addLbl(
      'lbl_arr_date', 'अटकेची / स्वाधीन होण्याची तारीख वेळ', marathiLabelStyle);
  ...
  await addLbl('lbl_court', 'न्यायालयाचे नांव ( स्वाधीन झाल्यास ) :-',
      marathiLabelStyle);
  ...
  await addLbl(
      'lbl_6ix_m1', '(अनु.जा/ अनु जमात/ इ.मा.व) :-', marathiLabelStyle);
  ...
  await addLbl('lbl_9_m1', 'शारीरीक वैशिष्टे आणि आरोपीचा इतर तपशील :-',
      marathiLabelStyle);
  ...
  await addLbl(
      ...
      marathiLabelStyle);
  await addLbl('lbl_11a_m2',
      'गलीच्छ वस्तीत राहतो/ बेघर किंवा आश्रय घेतलेला नाही.', marathiLabelStyle);
  ...
  await addLbl(
      'lbl_15_m3', FormIoTerminology.signatureHeader, marathiLabelStyle);
  ...
  for (final entry in tableHeaders.entries) {
    for (int j = 0; j < entry.value.length; j++) {
      if (containsDevanagari(entry.value[j])) {
        ...
        await cache.add(
            'tbl_h_${entry.key}_${j + 1}', entry.value[j], tblHeaderStyle);
      }
    }
  }
