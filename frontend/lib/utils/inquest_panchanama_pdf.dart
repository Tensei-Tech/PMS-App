...
Future<Uint8List> generateInquestPanchanamaPdf(Map<String, dynamic> doc) async {
  ...
  final englishStyle =
      pw.TextStyle(font: loraRegular, fontSize: 9, color: PdfColors.black);
  ...
  pw.Widget renderText(String key, String? val) {
    ...
    if (containsDevanagari(text) && cache.has(key)) {
      return pw.Container(
          alignment: pw.Alignment.topLeft, child: cache.img(key));
    }
        ...
        children: [
          pw.TableRow(
            ...
            children: [
              pw.Padding(
                padding: const pw.EdgeInsets.all(4),
                child: pw.Text('Question (प्रश्न)',
                    style: englishBold, textAlign: pw.TextAlign.center),
              ),
              pw.Padding(
                padding: const pw.EdgeInsets.all(4),
                child: pw.Text('Answer (उत्तर)',
                    style: englishBold, textAlign: pw.TextAlign.center),
              ),
            ],
          ),
    ...
    pw.MultiPage(
      ...
      build: (ctx) => [
        if (showsSection('Inquest Main')) ...[
          ...
          wideField('3) Place From where Dead Body Found/Traced:',
              'deadBodyFoundPlace'),
          pw.Wrap(
            spacing: 8,
            children: [
          ...
          wideField('8) Name and Address of Dead Body:', 'nameAddressDeceased',
              lines: 2),
          ...
          wideField('10) Injuries Caused By Accidental/Violence:',
          ...
          wideField(
              '14(a) Finger Print taken/not - Reason:', 'fingerprintReason'),
          wideField('14(b) Photo taken/not - Reason:', 'photoReason'),
          wideField(
              '15) Dead Body sent to P.M. / not reason:', 'sentToPMReason'),
          ...
          wideField('16) Opinion of Panchas and Police about Death:',
              'opinionPanchas',
              lines: 3),
        ...
        if (showsSection('Civil Surgeon PM Report')) ...[
          ...
          pw.Center(
            child: pw.Column(
              children: [
                pw.Text('Police Report to the Civil Surgeon',
                    style: sectionStyle),
                mImg('cs_hdr'),
              ],
            ),
          ...
          csTable([
            ...
            csRow('', 'csDeathTime'),
            csRow('5) Condition of body when found:', 'csBodyCondition',
                lines: 3),
            ...
            csRow('11) Cause of death / suspicions?', 'csDeathReason',
                lines: 3),
          ]),
          ...
          csTable([
            ...
            csRow('13) Woman pregnant/recently delivered?', 'csWomanPregnancy',
                lines: 2),
        ...
        if (showsSection('Marananveshan Panchanama')) ...[
          ...
          wideField('1) Panch Name & Address:', 'marPanchNameAddress',
              lines: 2),
          pw.Wrap(
              spacing: 8,
          ...
          wideField('12) Ornaments & belongings:', 'marBodyOrnaments',
              lines: 2),
          ...
          wideField('15) Ornaments disposal:', 'mar15OrnamentsDisposal',
              lines: 2),
        ...
        if (showsSection('14 Kalmi Form')) ...[
          ...
          wideField('14) Identifier name & address:', 'kal14IdentifierName',
              lines: 2),
          pw.Wrap(
            spacing: 8,
            children: [
