              ...
              Wrap(
                ...
                children: [
                  ...
                  _buildCheckbox(
                    ...
                    (v) =>
                        setState(() => _arrestedAndRemandedPolice = v ?? false),
                    serifStyle,
                  ),
                  _buildCheckbox(
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        _buildCheckbox(
                          'Living with Family',
                          _livingWithFamily,
                          (v) => setState(() => _livingWithFamily = v ?? false),
                          serifStyle,
                        ),
                        _buildCheckbox(
                          'with Associate',
                          ...
                          (v) =>
                              setState(() => _livingWithAssociate = v ?? false),
                          serifStyle,
                        ),
                        _buildCheckbox(
                          'in Pucca House',
                        ...
                        _buildCheckbox(
                          'Harbourer',
                          _livingHarbourer,
                          (v) => setState(() => _livingHarbourer = v ?? false),
                          serifStyle,
                        ),
                      ],
                    ),
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        _buildCheckbox(
                          ...
                          _incomeUpperMid2,
                          (v) => setState(() => _incomeUpperMid2 = v ?? false),
                          serifStyle,
                        ),
                        _buildCheckbox(
                ...
                child: Column(
                  children: [
                    ...
                    _buildYesNo(
                      ...
                      (v) =>
                          setState(() => _operatesWithAccomplices = v ?? false),
                      serifStyle,
                    ),
                    _buildYesNo(
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          FormIoTerminology.englishSignatureHeader,
                          style: serifStyle.copyWith(
                            fontWeight: FontWeight.bold,
                          ),
                        ),
