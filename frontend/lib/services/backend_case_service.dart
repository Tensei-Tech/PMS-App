...
class BackendCaseService {
  ...
  Future<List<Map<String, dynamic>>?> fetchCases({
    ...
    try {
      ...
      final response =
          await _api.get(ApiConfig.cases, queryParameters: queryParams);
  ...
  Future<List<Map<String, dynamic>>?> fetchAssignedCases(
    ...
    try {
      ...
      final response = await _api
          .get(url, queryParameters: {'active_only': activeOnly.toString()});
  ...
  Future<Map<String, dynamic>?> updateCase(
      String id, Map<String, dynamic> caseData) async {
    try {
      final url = '${ApiConfig.cases}$id/';
