...
Future<Uint8List> generateDraftGroundOfArrestPdf(
      ...
      children: [
        ...
        pw.Container(
          ...
          child: pw.Column(
            ...
            children: [
              pw.Text('Gaware Ashok', style: pw.TextStyle(font: devanagariBold, fontSize: 8)),
              pw.Text('Public Prosecutor A.Nagar', style: pw.TextStyle(font: devanagari, fontSize: 7)),
              pw.Text('9823911047', style: pw.TextStyle(font: devanagari, fontSize: 7)),
            ],
          ),
        ),
      ],
  ...
  final p9Match = section.contains('9') || section.contains('47') || section.contains('आधार');
  final p10Match = section.contains('10') || section.contains('48') || section.contains('नातेवाईक');
  final p11Match = section.contains('11') || section.contains('35') || section.contains('कारणे');
  final showAll = section.isEmpty || section.contains('complete') || (!p9Match && !p10Match && !p11Match);
          ...
          pw.TableRow(
            ...
            children: [
              ...
              pw.Container(
                ...
                child: pw.Text('अटकेचे आधार ( Ground of Arrest )', style: tableBold),
              ),
            ],
          ),
        ];
          ...
          p9GroundRows.add(
            pw.TableRow(
              children: [
                ...
                pw.Container(
                  padding: const pw.EdgeInsets.symmetric(vertical: 2.5, horizontal: 6),
                  child: pw.Text('फिर्यादीने दाखल केलेल्या FIR मध्ये तुमचे विरुद्ध आरोप केलेले आहेत.', style: tableRegular),
                ),
              ],
            ),
          );
                  ...
                  child: pw.RichText(
                    text: pw.TextSpan(
                      ...
                      children: [
                        ...
                        const pw.TextSpan(text: ' यांनी दिलेल्या जबाबानुसार गुन्ह्यामध्ये तुमचा थेट सहभाग असल्याचे निष्पन्न झाले आहे.'),
                      ],
                    ),
                  ),
                ),
          ...
          p9GroundRows.add(
            pw.TableRow(
              children: [
                ...
                pw.Container(
                  padding: const pw.EdgeInsets.symmetric(vertical: 2.5, horizontal: 6),
                  child: pw.Text('तुम्ही गुन्हा केल्याची कबुली दिली आहे.', style: tableRegular),
                ),
              ],
            ),
          );
                  ...
                  child: pw.RichText(
                    text: pw.TextSpan(
                      ...
                      children: [
                        ...
                        const pw.TextSpan(text: ' यांनी तुम्ही गुन्ह्यामध्ये सहभागी असल्याचे कबुल केले आहे.'),
                      ],
                    ),
                  ),
                ),
          ...
          children: [
            ...
            pw.RichText(
              text: pw.TextSpan(
                style: regular,
                children: [
                  pw.TextSpan(text: 'अटक केलेल्या आरोपीचे नाव: ', style: bold),
                  pw.TextSpan(
                    text: accusedName.isNotEmpty ? accusedName : '___________________________________________________________________',
            ...
            pw.RichText(
              text: pw.TextSpan(
                ...
                children: [
                  ...
                  pw.TextSpan(
                    text: accusedAddress.isNotEmpty ? accusedAddress : '______________________________________________________________',
            ...
            pw.RichText(
              ...
              text: pw.TextSpan(
                ...
                children: [
                  const pw.TextSpan(
                    text: 'या नोटीसद्वारे तुम्हाला माहिती करण्यात येते की, तुम्हाला पोलीस ठाणे ',
                  ),
                  pw.TextSpan(
            ...
            if (briefFacts.isNotEmpty) ...[
              pw.Text(briefFacts, style: regular, textAlign: pw.TextAlign.justify),
              pw.SizedBox(height: 3),
            ] else ...[
              pw.Container(height: 0.6, color: PdfColors.black, margin: const pw.EdgeInsets.symmetric(vertical: 4)),
              pw.Container(height: 0.6, color: PdfColors.black, margin: const pw.EdgeInsets.symmetric(vertical: 4)),
            ],
                        ...
                        text: pw.TextSpan(
                          ...
                          children: [
                            ...
                            pw.TextSpan(
                              ...
                              style: relativeName.isNotEmpty ? tableBold : tableRegular,
                            ),
                            const pw.TextSpan(text: ' यांना देण्यात आली आहे.'),
                          ],
                        ),
                      ),
                    ),
              ...
              children: [
                ...
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text('पोलीस अधिकारी नाव, हुद्दा सही शिक्का', style: regular),
                  ],
                ),
                pw.Column(
                  crossAxisAlignment: pw.CrossAxisAlignment.center,
          ...
          p10GroundRows.add(
            pw.TableRow(
              children: [
                ...
                pw.Container(
                  padding: const pw.EdgeInsets.symmetric(vertical: 2.5, horizontal: 6),
                  child: pw.Text('FIR मध्ये आरोपीने सदर गुन्हा केल्याचा उल्लेख आहे.', style: tableRegular),
                ),
              ],
            ),
          );
                  ...
                  child: pw.RichText(
                    text: pw.TextSpan(
                      ...
                      children: [
                        ...
                        const pw.TextSpan(
                          text: ' यांनी दिलेल्या जबाबानुसार गुन्ह्यामध्ये आरोपीचा थेट सहभाग असल्याचे निष्पन्न झाले आहे.',
                        ),
                      ],
                    ),
                  ),
          ...
          p10GroundRows.add(
            pw.TableRow(
              children: [
                ...
                pw.Container(
                  padding: const pw.EdgeInsets.symmetric(vertical: 2.5, horizontal: 6),
                  child: pw.Text('आरोपीने गुन्हा केल्याची कबुली दिली आहे.', style: tableRegular),
                ),
              ],
            ),
          );
                  ...
                  child: pw.RichText(
                    text: pw.TextSpan(
                      ...
                      children: [
                        const pw.TextSpan(text: 'गुन्ह्यातील सहआरोपी '),
                        pw.TextSpan(
                          text: coAccusedName.isNotEmpty ? coAccusedName : '_________________',
                          style: tableBold,
                        ),
                        const pw.TextSpan(
            ...
            pw.RichText(
              text: pw.TextSpan(
                ...
                children: [
                  ...
                  pw.TextSpan(
                    text: relativeName.isNotEmpty ? relativeName : '_____________________',
                  ...
                  pw.TextSpan(
                    text: relativeAddress.isNotEmpty ? relativeAddress : '____________________',
            ...
            pw.RichText(
              text: pw.TextSpan(
                ...
                children: [
                  ...
                  pw.TextSpan(
                    text: relationship.isNotEmpty ? relationship : '_________________________________________________',
            ...
            pw.RichText(
              ...
              text: pw.TextSpan(
                ...
                children: [
                  ...
                  pw.TextSpan(
                    text: accusedName.isNotEmpty ? accusedName : '_________________________',
                    style: accusedName.isNotEmpty ? bold : regular,
                  ),
                  ...
                  pw.TextSpan(
                    text: accusedAddress.isNotEmpty ? accusedAddress : '_________________',
                    style: accusedAddress.isNotEmpty ? bold : regular,
                  ),
                  ...
                  pw.TextSpan(
                    text: bnsSection.isNotEmpty ? bnsSection : '__________________',
                    style: bnsSection.isNotEmpty ? bold : regular,
                  ),
                  const pw.TextSpan(
                    text: ' अन्वये नोंदवलेल्या गुन्ह्याच्या तपासाच्या अनुषंगाने आज दिनांक ',
                  ),
                  pw.TextSpan(
                    text: arrestDate.isNotEmpty ? arrestDate : '_______________',
                    style: arrestDate.isNotEmpty ? bold : regular,
                  ),
                  const pw.TextSpan(text: ' रोजी वेळ '),
                  pw.TextSpan(
                  ...
                  const pw.TextSpan(text: ' वाजता कायदेशीररीत्या अटक करण्यात आली आहे.'),
                ],
              ),
            ),
            pw.SizedBox(height: 5),
                      ...
                      child: pw.RichText(
                        ...
                        text: pw.TextSpan(
                          ...
                          children: [
                            ...
                            pw.TextSpan(
                              text: accusedName.isNotEmpty ? accusedName : '___________________',
                              style: accusedName.isNotEmpty ? tableBold : tableRegular,
                            ),
                            const pw.TextSpan(text: ' यांना गुन्हा रजिस्टर क्रमांक '),
                            pw.TextSpan(
                              text: crNo.isNotEmpty ? crNo : '_______________',
                              style: crNo.isNotEmpty ? tableBold : tableRegular,
                            ),
                            const pw.TextSpan(text: ', अंतर्गत भारतीय न्याय संहिता, २०२३ (BNS) च्या कलम '),
                            pw.TextSpan(
                              text: bnsSection.isNotEmpty ? bnsSection : '__________________',
                              style: bnsSection.isNotEmpty ? tableBold : tableRegular,
                            ),
                            const pw.TextSpan(
                              text:
                            ...
                            pw.TextSpan(
                              text: custodyPs.isNotEmpty
                                  ? custodyPs
                                  : (psName.isNotEmpty ? psName : '________________________'),
                              style: tableBold,
                            ),
                            const pw.TextSpan(text: '] येथे ठेवण्यात आले आहे.'),
                          ],
                        ),
                      ),
                    ),
              ...
              children: [
                ...
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text('नातेवाईक/ मित्र यांचे नाव , सही, अंगठा', style: regular),
                  ],
                ),
              ],
            ),
          ...
          pw.TableRow(
            children: [
              ...
              pw.Container(
                padding: const pw.EdgeInsets.symmetric(vertical: 2.5, horizontal: 6),
                alignment: pw.Alignment.center,
                child: pw.Text('अटकेचे कारणे ( Reason of Arrest )', style: tableBold),
              ),
            ],
          ),
          pw.TableRow(
          ...
          children: [
            ...
            pw.RichText(
              text: pw.TextSpan(
                ...
                children: [
                  pw.TextSpan(text: 'वय:- ', style: bold),
                  pw.TextSpan(
                    text: accusedAge.isNotEmpty ? accusedAge : '______________',
                    style: accusedAge.isNotEmpty ? bold : regular,
                  ),
                  pw.TextSpan(text: ' वर्ष, पत्ता:- ', style: bold),
                  pw.TextSpan(
            ...
            pw.RichText(
              ...
              text: pw.TextSpan(
                ...
                children: [
                  const pw.TextSpan(
                    text: 'या नोटीसद्वारे तुम्हाला सूचित करण्यात येते की, पोलीस ठाणे ',
                  ),
                  pw.TextSpan(
                    text: psName.isNotEmpty ? '[ $psName ]' : '[पोलीस ठाण्याचे नाव]',
                    style: psName.isNotEmpty ? bold : regular,
                  ),
                  const pw.TextSpan(
                    text: ' येथे दाखल असलेल्या गुन्हा रजिस्टर क्रमांक ',
                  ...
                  pw.TextSpan(
                    text: bnsSection.isNotEmpty ? bnsSection : '______________',
                    style: bnsSection.isNotEmpty ? bold : regular,
                  ),
                  const pw.TextSpan(
                    text: ' अन्वये नोंदवलेल्या गुन्ह्यात तपासाच्या अनुषंगाने आज दिनांक ',
                  ),
                  pw.TextSpan(
