      ...
      children: [
        FormPaperPage(
          ...
          children: [
            ...
            _bilingualField('Consent / refusal details (record Yes/No choices)',
                'संमती / नकार तपशील (होय/नाही)', _fConsentCtrl, style, marathi,
                minLines: 8),
            _bilingualSection(
                'Signatures (Page 2)', 'सही (पृष्ठ २)', style, marathi),
            _bilingualField(
            ...
            _bilingualSection('13. Marks of identification',
                '१३. ओळखीच्या खुणा', style, marathi),
            BilingualFieldRow(fields: [
            ...
            Center(
              child: Column(
                children: [
                  ...
                  Text('डाव्या हाताचा अंगठ्याचा ठसा',
                      style: marathi.copyWith(fontSize: 9)),
                ],
              ),
            ),
            _bilingualSection('14. Relevant Medical/Surgical history',
                '१४. संबंधित वैद्यकीय / शस्त्रक्रिया इतिहास', style, marathi),
            _bilingualField('', 'मासिक पाळी, गर्भधारणा, लस, इ. तपशील',
                _fMedHistoryCtrl, style, marathi,
                minLines: 8),
          ],
        ),
        ...
        FormPaperPage(
          ...
          children: [
            ...
            _bilingualField('', 'घटना दिनांक, वेळ, ठिकाण, आरोपी, वर्णन',
                _fViolenceHistoryCtrl, style, marathi,
                minLines: 10),
            _bilingualSection('15 B. Type of physical violence used',
                '१५ ब. शारीरिक हिंसाचाराचा प्रकार', style, marathi),
            _bilingualField('', 'मारहाण, चाव, लाथ, डोके, इ.',
                _fPhysicalViolenceCtrl, style, marathi,
                minLines: 6),
            _bilingualSection(
                ...
                style,
                marathi),
            _bilingualField('', 'भावनिक/मानसिक छळ, नशा, इ.',
                _fEmotionalAbuseCtrl, style, marathi,
                minLines: 6),
            _bilingualField(
            ...
            _bilingualSection(
                ...
                marathi),
            _bilingualField(
                '', 'घटनोत्तर केलेली कृती', _fPostIncidentCtrl, style, marathi,
                minLines: 8),
            _bilingualField('16. General Physical Examination',
                '१६. सामान्य शारीरिक तपासणी', _fGeneralExamCtrl, style, marathi,
                minLines: 6),
          ],
        ),
        const SizedBox(height: 24),
        FormPaperPage(
          ...
          children: [
            _bilingualSection('17. Examination for injuries on the body',
                '१७. शरीरावरील जखमा तपासणी', style, marathi),
            for (var i = 0; i < _femaleInjuryLabels.length; i++)
              _bilingualField(_femaleInjuryLabels[i].$1,
                  _femaleInjuryLabels[i].$2, _fInjuryRows[i], style, marathi,
                  minLines: 2),
            _bilingualSection(
                ...
                style,
                marathi),
            _bilingualField('', 'समोरील आकृतीवरील खुणा', _fBodyFrontNotesCtrl,
                style, marathi,
                minLines: 6),
            _bilingualSection(
                ...
                marathi),
            _bilingualField(
                '', 'मागील आकृतीवरील खुणा', _fBodyBackNotesCtrl, style, marathi,
                minLines: 6),
          ],
        ),
        const SizedBox(height: 24),
        FormPaperPage(
          ...
          children: [
            _bilingualSection(
                ...
                marathi),
            _bilingualField(
                '', 'स्थानिक तपासणी तपशील', _fGenitalExamCtrl, style, marathi,
                minLines: 12),
            _bilingualSection('19. Systemic examination',
                '१९. प्रणालीगत तपासणी', style, marathi),
            _bilingualField(
                '', 'प्रणालीगत तपासणी', _fSystemicExamCtrl, style, marathi,
                minLines: 6),
            _bilingualSection('Page 10 — Anatomical diagram notes',
                'पृ. १० — शारीरिक आकृती टिपणी', style, marathi),
            _bilingualField(
                '', 'आकृती टिपणी', _fGenitalDiagramNotesCtrl, style, marathi,
                minLines: 8),
          ],
        ),
        const SizedBox(height: 24),
        FormPaperPage(
          ...
          children: [
            _bilingualSection('20. Sample collection — hospital laboratory',
                '२०. नमुने — रुग्णालय प्रयोगशाळा', style, marathi),
            _bilingualField(
                '', 'प्रयोगशाळा नमुने', _fLabSamplesCtrl, style, marathi,
                minLines: 4),
            _bilingualSection('21. Samples for Forensic Science Laboratory',
                '२१. फॉरेन्सिक विज्ञान प्रयोगशाळेसाठी नमुने', style, marathi),
            _bilingualField(
                '', 'एफ.एस.एल. नमुने', _fFslSamplesCtrl, style, marathi,
                minLines: 8),
            _bilingualSection('Genital and Anal evidence (Page 12)',
                'गुप्तांग व गुदद्वार पुरावा (पृ. १२)', style, marathi),
            _bilingualField(
                '', 'पुरावा तपशील', _fGenitalEvidenceCtrl, style, marathi,
                minLines: 8),
            _bilingualSection('22. Provisional medical opinion',
                '२२. तात्पुरती वैद्यकीय मते', style, marathi),
            _bilingualField(
                '', 'तात्पुरते मत', _fProvisionalOpinionCtrl, style, marathi,
                minLines: 8),
            _bilingualSection(
                '23. Treatment prescribed', '२३. दिलेला उपचार', style, marathi),
            _bilingualField('', 'उपचार', _fTreatmentCtrl, style, marathi,
                minLines: 6),
            _bilingualSection('24–25. Completion & Final Opinion',
                '२४–२५. पूर्णता व अंतिम मत', style, marathi),
            _bilingualField(
                ...
                marathi,
                minLines: 4),
            _bilingualField('25. Final Opinion (after Lab reports)',
                '२५. अंतिम मत (अहवालानंतर)', _fFinalOpinionCtrl, style, marathi,
                minLines: 8),
            const SizedBox(height: 8),
            Text(
    ...
    return Column(
      children: [
        ...
        FormPaperPage(
          ...
          children: [
            ...
            _bilingualSection(
                ...
                style,
                marathi),
            _bilingualField('', 'नमुने', _mLabSamplesCtrl, style, marathi,
                minLines: 8),
            _bilingualSection('(IX) Samples / Forensic Evidence for FSL',
                '(९) एफ.एस.एल.साठी फॉरेन्सिक पुरावा', style, marathi),
            _bilingualField('Note (If any)', 'टिपणी (असल्यास)', _mFslNoteCtrl,
                style, marathi,
                minLines: 6),
          ],
        ),
        ...
        FormPaperPage(
          ...
          children: [
            _bilingualSection(
                'PROVISIONAL OPINION', 'तात्पुरते वैद्यकीय मत', style, marathi),
            _bilingualField(
                '', 'तात्पुरते मत', _mProvisionalOpinionCtrl, style, marathi,
                minLines: 10),
            _bilingualField('Signature / Name of Dr. / Designation',
                'डॉ. सही / नाव / पदनाम', _mDoctorSigCtrl, style, marathi,
                minLines: 3),
            _bilingualSection('RECEIPT (by police official)',
                'पोलीस अधिकाऱ्याची पावती', style, marathi),
            _bilingualField(
                '', 'पावती तपशील', _mReceiptPoliceCtrl, style, marathi,
                minLines: 4),
