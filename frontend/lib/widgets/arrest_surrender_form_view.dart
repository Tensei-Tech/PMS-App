...
class ArrestSurrenderFormView extends StatefulWidget {
  ...
  @override
  State<ArrestSurrenderFormView> createState() =>
      ArrestSurrenderFormViewState();
}
      ...
      children: [
        ...
        TableRow(
            children: List.generate(
                10,
                (i) => _buildTableCell(
                    _physTableCtrl[(i + 1).toString()]!, serifStyle))),
      ],
    );
  }
      ...
      children: [
        ...
        TableRow(
            children: List.generate(
                10,
                (i) => _buildTableCell(
                    _physTableCtrl[(i + 11).toString()]!, serifStyle))),
      ],
    );
  }
      ...
      children: [
        ...
        TableRow(
            children: List.generate(
                6,
                (i) => _buildTableCell(
                    _physTableCtrl[(i + 21).toString()]!, serifStyle))),
      ],
    );
  }
        ...
        if (_shows(kForm3A))
          FormPaperPage(
            ...
            children: [
              ...
              BilingualSectionHeader(
                  label: '5)',
                  marathiLabel: 'अटक / स्वाधीन स्थिती',
                  serifStyle: serifStyle,
                  marathiLabelStyle: marathiLabelStyle),
              const SizedBox(height: 8),
              Wrap(
                ...
                children: [
                  _buildCheckbox(
                      ...
                      _arrestedAndForwarded,
                      (v) => setState(() => _arrestedAndForwarded = v ?? false),
                      serifStyle),
                  _buildCheckbox(
                      'Arrested and released on bail or PR bound',
                      _arrestedAndBailed,
                      (v) => setState(() => _arrestedAndBailed = v ?? false),
                      serifStyle),
                  _buildCheckbox(
                      'Arrested but released on anticipatory bail',
                      _arrestedButAnticipatory,
                      (v) =>
                          setState(() => _arrestedButAnticipatory = v ?? false),
                      serifStyle),
                  _buildCheckbox(
                      'Arrested and remanded to police Custody',
                      _arrestedAndRemandedPolice,
                      (v) => setState(
                          () => _arrestedAndRemandedPolice = v ?? false),
                      serifStyle),
                  _buildCheckbox(
                      'Surrender in court and bailed out',
                      _surrenderBailed,
                      (v) => setState(() => _surrenderBailed = v ?? false),
                      serifStyle),
                  _buildCheckbox(
                      'Surrender in court and sent to judicial Custody',
                      _surrenderJudicial,
                      (v) => setState(() => _surrenderJudicial = v ?? false),
                      serifStyle),
                  _buildCheckbox(
                      'Surrender in court and remanded to police custody',
                      _surrenderPolice,
                      (v) => setState(() => _surrenderPolice = v ?? false),
                      serifStyle),
                ],
              ),
              const SizedBox(height: 24),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    BilingualWideField(
                        label: '(ii) Father\'s/Husband\'s/Guardian\'s Name :- ',
                        marathiLabel: 'वडिलांचे/पतीचे/पालकाचे नांव',
                        controller: _accusedFatherCtrl,
                        serifStyle: serifStyle,
                        marathiLabelStyle: marathiLabelStyle),
                    const SizedBox(height: 12),
                    BilingualWideField(
                        label: '(iii) First Alias (पहिले टोपण नांव) :- ',
                        marathiLabel: 'पहिले टोपण नांव',
                        controller: _accusedAlias1Ctrl,
                        serifStyle: serifStyle,
                        marathiLabelStyle: marathiLabelStyle),
                    const SizedBox(height: 12),
                    BilingualWideField(
                        label: '(iv) Second Alias (दुसरे टोपण नांव) :- ',
                        marathiLabel: 'दुसरे टोपण नांव',
                        controller: _accusedAlias2Ctrl,
                        serifStyle: serifStyle,
                        marathiLabelStyle: marathiLabelStyle),
                    const SizedBox(height: 12),
                    BilingualWideField(
                        label: '(v) Nationality (राष्ट्रीयत्व) :- ',
                        marathiLabel: 'राष्ट्रीयत्व',
                        controller: _accusedNationalityCtrl,
                        serifStyle: serifStyle,
                        marathiLabelStyle: marathiLabelStyle),
                    const SizedBox(height: 12),
                    BilingualFieldRow(fields: [
                      BilingualField(
                          label: '(vi) (a) Voter ID Card No: - ',
                          marathiLabel: 'मतदार ओळखपत्र क्र.',
                          controller: _accusedVoterCtrl,
                          serifStyle: serifStyle,
                          marathiLabelStyle: marathiLabelStyle),
                      BilingualField(
                          label: '(b) *Passport No: - ',
                          marathiLabel: 'पासपोर्ट क्र.',
                    ...
                    BilingualFieldRow(fields: [
                      BilingualField(
                          label: '(c) Date of issue :- ',
                          marathiLabel: 'जारी केल्याची तारीख',
                          controller: _accusedDateIssueCtrl,
                          serifStyle: serifStyle,
                          marathiLabelStyle: marathiLabelStyle),
                      BilingualField(
                          label: '(d) *Place of Issue :- ',
                          marathiLabel: 'जारी केल्याचे ठिकाण',
                    ...
                    BilingualMultilineField(
                        label: '(xi) Permanent Address :-',
                        marathiLabel: 'स्थायी पत्ता',
                    ...
                    const SizedBox(height: 12),
                    BilingualMultilineField(
                        label: '(xii) Present Address:-',
                        marathiLabel: 'सध्याचा पत्ता',
            ...
            children: [
              ...
              BilingualFieldRow(fields: [
                BilingualField(
                    label: '(date) at :- ',
                    marathiLabel: 'दिनांक',
                    controller: _custodyDateCtrl,
                    serifStyle: serifStyle,
                    marathiLabelStyle: marathiLabelStyle),
                BilingualField(
                    label: '(hours) at :- ',
                    marathiLabel: 'वेळ',
                    controller: _custodyHoursCtrl,
                    serifStyle: serifStyle,
                    marathiLabelStyle: marathiLabelStyle),
                BilingualField(
                    label: '(place). ',
              ...
              BilingualFieldRow(fields: [
                BilingualField(
                    label: 'Intimation given to Name: ',
                    marathiLabel: 'सूचना दिली — नांव',
          ...
          FormPaperPage(
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        _buildCheckbox(
                            'Living alone',
                            _livingAlone,
                            (v) => setState(() => _livingAlone = v ?? false),
                            serifStyle),
                        _buildCheckbox(
                            'Living with Family',
                            _livingWithFamily,
                            (v) =>
                                setState(() => _livingWithFamily = v ?? false),
                            serifStyle),
                        _buildCheckbox(
                            'with Associate',
                            _livingWithAssociate,
                            (v) => setState(
                                () => _livingWithAssociate = v ?? false),
                            serifStyle),
                        _buildCheckbox(
                            'in Pucca House',
                            _livingPucca,
                            (v) => setState(() => _livingPucca = v ?? false),
                            serifStyle),
                        _buildCheckbox(
                            'Hotel',
                            _livingHotel,
                            (v) => setState(() => _livingHotel = v ?? false),
                            serifStyle),
                        _buildCheckbox(
                            'Hostel',
                            _livingHostel,
                            (v) => setState(() => _livingHostel = v ?? false),
                            serifStyle),
                        _buildCheckbox(
                            'Kachcha House',
                            _livingKachcha,
                            (v) => setState(() => _livingKachcha = v ?? false),
                            serifStyle),
                        _buildCheckbox(
                            'Thatched House',
                            _livingThatched,
                            (v) => setState(() => _livingThatched = v ?? false),
                            serifStyle),
                        _buildCheckbox(
                            'Slum',
                            _livingSlum,
                            (v) => setState(() => _livingSlum = v ?? false),
                            serifStyle),
                        _buildCheckbox(
                            'Homeless',
                            _livingHomeless,
                            (v) => setState(() => _livingHomeless = v ?? false),
                            serifStyle),
                        _buildCheckbox(
                            'Harbourer',
                            _livingHarbourer,
                            (v) =>
                                setState(() => _livingHarbourer = v ?? false),
                            serifStyle),
                      ],
                    ),
                    const SizedBox(height: 16),
                    BilingualFieldRow(fields: [
                      BilingualField(
                          label: '(b) Educational qualification(s): ',
                          marathiLabel: 'शैक्षणिक पात्रता',
                    ...
                    const SizedBox(height: 16),
                    Text('(d) Income Group (उत्पन्न गट) :-',
                        style:
                            serifStyle.copyWith(fontWeight: FontWeight.bold)),
                    const SizedBox(height: 8),
                    Wrap(
                      ...
                      children: [
                        _buildCheckbox(
                            '(i) Lower Income (Below Rs. 25000 P.Y.)',
                            _incomeLower,
                            (v) => setState(() => _incomeLower = v ?? false),
                            serifStyle),
                        _buildCheckbox(
                            '(ii) Lower Middle Income (From Rs. 25001 to 50000)',
                            _incomeLowerMid,
                            (v) => setState(() => _incomeLowerMid = v ?? false),
                            serifStyle),
                        _buildCheckbox(
                            '(iii) Middle Income (From 50001 to 100000)',
                            _incomeMiddle,
                            (v) => setState(() => _incomeMiddle = v ?? false),
                            serifStyle),
                        _buildCheckbox(
                            '(iv) Upper Middle Income (From 100000 to 200000)',
                            _incomeUpperMid,
                            (v) => setState(() => _incomeUpperMid = v ?? false),
                            serifStyle),
                        _buildCheckbox(
                            '(v) Upper Middle Income (Rs. 200000 to 300000)',
                            _incomeUpperMid2,
                            (v) =>
                                setState(() => _incomeUpperMid2 = v ?? false),
                            serifStyle),
                        _buildCheckbox(
                            '(vi) Upper Income (above 300000)',
                            _incomeUpper,
                            (v) => setState(() => _incomeUpper = v ?? false),
                            serifStyle),
                      ],
                    ),
                  ],
              ...
              BilingualSectionHeader(
                ...
                marathiLabel:
                    '१२. निरीक्षणावरून व पोलीसां जवळील माहितीनुसार आरोपी',
                serifStyle: serifStyle,
                marathiLabelStyle: marathiLabelStyle,
              ),
              Padding(
                ...
                child: Column(
                  children: [
                    _buildYesNo(
                        ...
                        _isDangerous,
                        (v) => setState(() => _isDangerous = v ?? false),
                        serifStyle),
                    _buildYesNo(
                        '(b) Previously escaped any bail ?',
                        _prevEscaped,
                        (v) => setState(() => _prevEscaped = v ?? false),
                        serifStyle),
                    _buildYesNo(
                        '(c) Is generally armed?',
                        _generallyArmed,
                        (v) => setState(() => _generallyArmed = v ?? false),
                        serifStyle),
                    _buildYesNo(
                        '(d) Operates with accomplices?',
                        _operatesWithAccomplices,
                        (v) => setState(
                            () => _operatesWithAccomplices = v ?? false),
                        serifStyle),
                    _buildYesNo(
                        '(e) Has past criminal records ?',
                        _pastCriminal,
                        (v) => setState(() => _pastCriminal = v ?? false),
                        serifStyle),
                    _buildYesNo(
                        '(f) Is recidivism?',
                        _isRecidivism,
                        (v) => setState(() => _isRecidivism = v ?? false),
                        serifStyle),
                    _buildYesNo(
                        '(g) Is likely to escape bail ?',
                        _likelyToEscape,
                        (v) => setState(() => _likelyToEscape = v ?? false),
                        serifStyle),
                    _buildYesNo(
                        '(h) Is released on bail. Likely to commit crime or threaten victims/witnesses.',
                        _releasedOnBail,
                        (v) => setState(() => _releasedOnBail = v ?? false),
                        serifStyle),
                    _buildYesNo(
                        '(i) Is wanted in any other case?',
                        _wantedMany,
                        (v) => setState(() => _wantedMany = v ?? false),
                        serifStyle),
                    const SizedBox(height: 8),
                    BilingualWideField(
                      label: '(If yes give case ref. Sec.): ',
                      marathiLabel:
                          'जर होय असेल तर त्या प्रकरणाचा संदर्भ व कलमे',
              ...
              // 13) Panchas
              BilingualSectionHeader(
                  label: '13) Panch names / signatures',
                  marathiLabel: 'पंचाची नांवे / सह्या',
                  serifStyle: serifStyle,
                  marathiLabelStyle: marathiLabelStyle),
              const SizedBox(height: 12),
              Row(
                    ...
                    child: Column(
                      ...
                      children: [
                        BilingualWideField(
                            ...
                            marathiLabelStyle: marathiLabelStyle),
                        Text(
                            'Name and Address of witnesses/Panchas (At least one witness necessary)',
                            style: serifStyle.copyWith(
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                            '14) Signature and Thumb impression of Arrested person',
                            style: serifStyle.copyWith(
                                fontWeight: FontWeight.bold)),
                        const SizedBox(height: 12),
                        BilingualWideField(
                            label: 'Signature :- ',
                            marathiLabel: 'सही',
                            controller: _arrestedPersonSigCtrl,
                            serifStyle: serifStyle,
                            marathiLabelStyle: marathiLabelStyle),
                      ],
                    ),
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(FormIoTerminology.englishSignatureHeader,
                            style: serifStyle.copyWith(
                                fontWeight: FontWeight.bold)),
                        Text(FormIoTerminology.signatureHeader,
                            style: marathiLabelStyle),
                        const SizedBox(height: 12),
                        BilingualField(
                            label: 'Signature / सही :- ',
                            marathiLabel: FormIoTerminology.signature,
