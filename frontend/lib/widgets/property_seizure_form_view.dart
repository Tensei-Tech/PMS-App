...
class PropertySeizureFormViewState extends State<PropertySeizureFormView> {
  ...
  final List<SealPropertyRow> _sealPropertyRows =
      List.generate(5, (_) => SealPropertyRow());
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(FormIoTerminology.amaldarSignatureHeader,
                            style: marathiStyle),
                        const SizedBox(height: 8),
                        ResponsiveFieldRow(
                          crossAxisAlignment: CrossAxisAlignment.end,
                        ...
                        Wrap(
                          spacing: 8,
                          children: [
                            Text('${FormIoTerminology.rank} :',
                                style: marathiStyle),
                            Text('${FormIoTerminology.badgeNo} :',
                                style: marathiStyle),
                          ],
                        ),
                      ],
