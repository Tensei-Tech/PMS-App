...
class AccusedInterrogationFormView extends StatefulWidget {
  final bool readOnly;
  final Map<String, dynamic>? existingRecord;
  final String? formSection;
  final String? pageRange;

  const AccusedInterrogationFormView({
    super.key,
    this.readOnly = false,
    this.existingRecord,
    this.formSection,
  ...
  @override
  State<AccusedInterrogationFormView> createState() =>
      AccusedInterrogationFormViewState();
}

class AccusedInterrogationFormViewState
    extends State<AccusedInterrogationFormView> {
