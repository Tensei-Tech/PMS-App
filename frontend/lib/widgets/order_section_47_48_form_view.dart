    ...
    return FormPaperPage(
      ...
      children: [
        Center(
          child: Column(
            children: [
              Text('ORDER — Sections 47 & 48 BNSS',
                  style: serif.copyWith(
                      fontSize: 16, fontWeight: FontWeight.bold)),
              Text('आदेश — कलम ४७ व ४८ भा.न्या.स.',
    ...
    return FormPaperPage(
      ...
      children: [
        Center(
          child: Column(
            children: [
              Text('NOTICE u/s 47(1) BNSS',
                  style: serif.copyWith(
                      fontSize: 16, fontWeight: FontWeight.bold)),
              Text('सूचनापत्र — कलम ४७(१) भा.न्या.स.',
                  style: marathi.copyWith(
                      fontSize: 13, fontWeight: FontWeight.bold)),
            ],
          ),
    ...
    return FormPaperPage(
      ...
      children: [
        Center(
          child: Column(
            children: [
              Text('NOTICE u/s 48 BNSS',
                  style: serif.copyWith(
                      fontSize: 16, fontWeight: FontWeight.bold)),
              Text('सूचनापत्र — कलम ४८ भा.न्या.स.',
                  style: marathi.copyWith(
                      fontSize: 13, fontWeight: FontWeight.bold)),
            ],
          ),
